...
class CounterProgress extends Component{
  constructor(){
    super();
  ...
  componentWillUpdate(nextProps){
    this.updateProgress(nextProps.progress);
  }
  updateProgress(progress){
    const progressPercent = this.props.progress * 100;
    this.water.style.transform = 'translate(0, ' + (100 - progressPercent) + '%)';
    this.waterInner.style.height = progressPercent + '%';
  }
  render(){
    return (
      <div className="counter-progress">
        ...
        <div className="water" id="water" ref={e => (this.water = e)}>
          ...
          <div className="water__inner" ref={e => (this.waterInner = e)} />
        </div>
      </div>
    );
  }
